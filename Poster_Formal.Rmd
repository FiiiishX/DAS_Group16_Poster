...
As defined by the World Bank, extreme poverty is the person who living on $1.90 per day.


```{r data process for question 1,out.width = '68%', fig.align = "center", fig.cap = "\\label{fig:Scatterplots} Scatterplots of 100 employees.",fig.pos = 'H'}
...
## Create two column which divide dataset into two category 
...
ggplot(data = poverty_population_for_plot,aes(x = Year, y = value,fill = income_level)) +
  geom_col(position = 'fill', stat = "identity",width = 0.6)+
  labs(x = "Year", y = "Population",
        title = "World income levels from 2013-2018") +
  guides(color=guide_legend(title = "Income level"))
